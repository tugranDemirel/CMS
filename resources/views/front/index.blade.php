...
@section('content')
            ...
            <ul class="row counters">
                <li class="col-md-3 col-sm-6 sm-padding">
                    <div class="counter-content text-center">
                        ...
                        <h3 class="counter">{{ $setting[0]['year_experience'] }}</h3>
                        <h4 class="text-white">@lang('general.year_experince')</h4>
                    </div>
                </li>
                <li class="col-md-3 col-sm-6 sm-padding">
                    <div class="counter-content text-center">
                        <i class="ti-cup"></i>
                        <h3 class="counter">{{ $setting[0]['year_won'] }}</h3>
                ...
                <li class="col-md-3 col-sm-6 sm-padding">
                    <div class="counter-content text-center">
                        <i class="ti-user"></i>
                        <h3 class="counter">{{ $setting[0]['expart_stuff'] }}</h3>
                        <h4 class="text-white">@lang('general.expart_stuff')</h4>
                    </div>
                </li>
                <li class="col-md-3 col-sm-6 sm-padding">
                    <div class="counter-content text-center">
                        <i class="ti-face-smile"></i>
                        <h3 class="counter">{{ $setting[0]['happy_customer'] }}</h3>
    ...
    <section class="project-section bg-grey bd-bottom padding">
        <div class="container">
            <div class="section-heading mb-40 text-center">
                ...
                <h2>@lang('general.last_project')</h2>
            </div>
            <div id="project-carousel" class="project-carousel owl-carousel">
                ...
                <div class="project-item">
                    ...
                    <div class="project-content">
                        <h3><a href="{{ $v['url'] }}" target="_blank">{{ \App\LanguageContent::get(\App\Helper\mHelper::getLanguageId(), PROJECT_LANGUAGE, NAME_LANGUAGE, $v['id']) }}</a></h3>
                        ...
                        <a href="{{ $v['url'] }}" class="project-btn" target="_blank">@lang('general.view_project')</a>
                    </div>
                </div> <!-- Item 1 -->
                @endforeach
            </div>
    ...
    <section class="request-section padding bd-bottom" id="online_offer">
        <div class="container">
                ...
                <div class="col-md-4 col-sm-6 xs-padding">
                    <div class="blog-post">
                        ...
                        <div class="blog-content">
                            ...
                            <h3><a href="{{ \App\LanguageContent::get(\App\Helper\mHelper::getLanguageId(), BLOG_LANGUAGE, SLUG_LANGUAGE, $v['id']) }}">{{ \App\LanguageContent::get(\App\Helper\mHelper::getLanguageId(), BLOG_LANGUAGE, TITLE_LANGUAGE, $v['id']) }}</a></h3>
                            ...
                            <a href="{{ \App\LanguageContent::get(\App\Helper\mHelper::getLanguageId(), BLOG_LANGUAGE, SLUG_LANGUAGE, $v['id']) }}" class="post-meta">@lang('general.read_more')</a>
                        </div>
                    </div>
                </div><!-- Post 1 -->
                @endforeach
