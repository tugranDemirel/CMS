            ...
            <div class="row contact-wrap">
                <div class="col-md-6 xs-padding">
                    <div class="contact-info">
                        ...
                        <ul>
                            <li><i class="ti-mobile"></i>{{ \App\Setting::get('phone')[0]['phone'] }}</li>
                            <li><i class="ti-email"></i> {{ \App\Setting::get('email')[0]['email'] }}</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 xs-padding">
                    <div class="contact-form">
                        ...
                        <form action="{{ route('front.contact.store') }}" method="post" id="" class="form-horizontal">
                            @csrf
