...
@section('seo')
    <title> {{\App\LanguageContent::getTitle(BLOG_CATEGORY_LANGUAGE, $categoryId)}}</title>
    <meta name="description" content="{{\App\LanguageContent::getDescription(BLOG_CATEGORY_LANGUAGE, $categoryId)}}">
    <meta name="keywords" content="{{\App\LanguageContent::getKeywords(BLOG_CATEGORY_LANGUAGE, $categoryId)}}">
@endsection
@section('css')
@endsection
@section('content')
                            ...
                            <div class="col-sm-6 padding-15">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <a href="{{ route('front.blog.view', ['slug'=>\App\LanguageContent::getSlug(BLOG_LANGUAGE, $v['id'])]) }}" class="post-meta">@lang('general.read_more')</a>
                                    </div>
                                </div>
                            </div><!-- Post 1 -->
                        @endforeach
