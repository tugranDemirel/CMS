...
<div class="peers ai-s fxw-nw h-100vh">
    ...
    <div class="col-12 col-md-4 peer pX-40 pY-80 h-100 bgc-white scrollable pos-r" style="min-width:320px">
        ...
        <form action="/login" method="POST">
            @csrf
            <div class="mb-3"><label class="text-normal text-dark form-label">Email</label> <input type="email" class="form-control" name="email"></div>
            <div class="mb-3"><label class="text-normal text-dark form-label">Şifre</label> <input type="password" class="form-control" name="password"></div>
            <div class="">
                <div class="peers ai-c jc-sb fxw-nw">
                    <div class="peer"><button class="btn btn-primary btn-color">Giriş Yap</button></div>
                </div>
            </div>
        </form>
    </div>
