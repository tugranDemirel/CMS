                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" name="title[{{$v['id']}}]" class="form-control slug-name" id="exampleInputEmail1">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label" for="exampleInputEmail1">Slider Açıklama[{{$v['name']}}]</label>
                                            <input required type="text" name="description[{{$v['id']}}]" class="form-control" id="exampleInputEmail1">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label" for="exampleInputEmail1">Slider URL[{{$v['name']}}]</label>
                                            <input required type="text" name="url[{{$v['id']}}]" class="form-control slug-url" id="exampleInputEmail1">
                                        </div>
                                    </div>
                                </div>
